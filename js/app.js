...
const I18N = {
  ...
  "goldRatePage.disclaimer": { en: "<strong>Please Note:</strong> The rates shown above are indicative prices for plain, unworked gold only, and are simulated estimation indicators — not a live exchange feed. Jewellery purchased in-store is priced separately based on its design, weight, purity, craftsmanship, and applicable taxes, and will differ from the plain gold rate shown here. Please call or visit our Sigra or Godowlia showroom for the exact, confirmed price of any piece.", hi: "<strong>कृपया ध्यान दें:</strong> ऊपर दिखाए गए भाव केवल सादे, अनगढ़े सोने के लिए संकेतात्मक मूल्य हैं, और अनुमानित संकेतक हैं — न कि लाइव एक्सचेंज फीड। स्टोर में खरीदी गई ज्वेलरी की कीमत उसके डिज़ाइन, वजन, शुद्धता, कारीगरी, और लागू करों के आधार पर अलग से तय होती है, और यहां दिखाए गए सादे सोने के भाव से भिन्न होगी। किसी भी वस्तु के सटीक, पुष्ट मूल्य हेतु कृपया हमारे सिगरा या गोदौलिया शोरूम पर कॉल करें या पधारें।" },
